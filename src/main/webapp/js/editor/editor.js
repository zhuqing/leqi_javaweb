...
app.controller("markdownEditorController", function ($scope,$http) {
    ...
    $scope.onPublish = function() {
        ...
        //     data:"{title:'"+$scope.editor.title+"',content:'"+$scope.editor.src+"',userId:'"+$.cookie("userId")+"'}",
        ...
        $.ajax({
            ...
            data:JSON.stringify({title:$scope.editor.title,content:$scope.editor.src,userId:$.cookie("userId")}),
            // data:"{title:'"+$scope.editor.title+"',content:'"+$scope.editor.src+"',userId:'"+$.cookie("userId")+"'}",
